...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('asosiy', '0002_remove_plan_bolim_remove_plan_profil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profil', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asosiy.profil')),
            ],
        ),
        migrations.AddField(
            model_name='bolim',
            name='profil',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asosiy.profil'),
        ),
    ]
